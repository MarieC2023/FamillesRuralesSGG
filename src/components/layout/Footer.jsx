  ...
  return (
    <footer className="footer">
      <div className="footer-container">
        ...
        <img src={logo} alt="Logo périscolaire" className="footer-logo" />

<div className="footer-bottom">
        <p className="footer-text">
          Site réalisé par Marie Collet <span className="heart" aria-label="amour" role="img">❤️</span> — avec une tasse
          <span aria-label="tasse de café" role="img">☕</span> et un soupçon de bonne humeur garantie.
        </p>

        <div className="footer-icons">
          <a href="https://www.facebook.com/profile.php?id=61568676522423&sfnsn=scwspmo" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24" className="icon-facebook">
          ...
          <a href="https://www.instagram.com/familles_rurales_stgdg?utm_source=qr&igsh=YnJiODN3cnJhamJt" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" className="icon-instagram">
