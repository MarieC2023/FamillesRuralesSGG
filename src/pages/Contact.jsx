    ...
    return (
        <section className="contact-section">
            ...
            <div className="formulaires-container">
                <FormulaireContact
                    templateId="template_fmr919q"
                    titre="Périscolaire / Centre de loisirs"
                />
                <FormulaireContact
                    templateId="template_imeacw8"
